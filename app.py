...
# Script com botão de cópia e aviso de sucesso
st.markdown(f"""
    <script>
    function copiarTexto() {{
        const textarea = document.getElementsByName('resultado_formatado')[0];
        textarea.select();
        document.execCommand('copy');
        const aviso = document.getElementById('copiado-feedback');
    ...
    <p id="copiado-feedback" style="display:none;color:green;margin-top:10px;">✔ Texto copiado!</p>
